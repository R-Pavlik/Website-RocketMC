...
export default function Hero() {
  return (
    <div className='relative w-screen h-[480px] flex flex-col justify-center items-center'>
        ...
        <h1 className='  text-white kanitfont text-6xl'>CONTACT</h1>
        <h1 className='  text-white lexendfont text-xl'>Do you want to contact us? <br/> 
        There is list of ways you can contact us!</h1>
